...
import { DashboardPage } from "../pages ts/DashBoardPage";
import { ProductsPage } from "../pages ts/ProductsPage";
import { PlaceOrderPage } from "../pages ts/PlaceOrderPage";
import { OrdersReviewPage } from "../pages ts/OrdersReviewPage";
import { OrderListPage } from "../pages ts/OrdersListPage";
import { OrderSummaryPage } from "../pages ts/OrderSummaryPage";
...
test(`Login Authentication for ${data.productName}`, async ({ page }) => {
  ...
  expect(orderID).toContain(orderIDInPage);
});
}